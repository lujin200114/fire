...
// [task_local]
//#博越
// 10 */1 * * * https://raw.githubusercontent.com/lujin200114/fire/main/app_by.js, tag=博越APP, enabled=true
...
function qiandaogoodslist(timeout = 0) {
  return new Promise((resolve) => {
    let url = {
      url: `https://www.lnasgjp.com/api/user/qiandaogoodslist`,
      headers: {
        'Host': 'www.lnasgjp.com',
        'Content-Type': 'pplication/json;charset=utf-8',
        'Origin': 'https://www.lnasgjp.com',
...
function qiandaonum(timeout = 0) {
  return new Promise((resolve) => {
    let url = {
      url: `https://www.lnasgjp.com/api/user/qiandaonum`,
      headers: {
        'Host': 'www.lnasgjp.com',
        'Content-Type': 'pplication/json;charset=utf-8',
        'Origin': 'https://www.lnasgjp.com',
...
function qiandao(num) {
  return new Promise((resolve) => {
    let url = {
      url: `https://www.lnasgjp.com/api/user/qiandao`,
      headers: {
        'Host': 'www.lnasgjp.com',
        'Content-Type': 'pplication/json;charset=utf-8',
        'Origin': 'https://www.lnasgjp.com',
...
function takeExercises7(token) {
  ...
  return new Promise((resolve) => {
	...
	let url = {
      url: `http://www.lnasgjp.com/api/index/takeExercises`,
      headers: {
        'Host': 'www.lnasgjp.com',
        'Content-Type': 'application/json;charset=utf-8',
        'Origin': 'https://www.lnasgjp.com',
...
function receiveRewardsExercises2(token) {
  ...
  return new Promise((resolve) => {
	...
	let url = {
      url: `http://www.lnasgjp.com/api/index/receiveRewardsExercises`,
      headers: {
        'Host': 'www.lnasgjp.com',
        'Content-Type': 'application/json;charset=utf-8',
        'Origin': 'https://www.lnasgjp.com',
